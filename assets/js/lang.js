let arrLang = {
  ...
  'de': {
    ...
    'aboutMe': 'ÜBER MICH',
    'aboutPO': 'Hallo, ich bin Solya! Ich bin Webentwicklerin und UI-Designerin aus Bremen (ursprünglich komme ich aus Lwiw, Ukraine). Ich bin spezialisiert auf die Entwicklung und Gestaltung von Web-Apps, mit Liebe zum Detail.',
    'aboutPT': 'Ich helfe Unternehmen dabei, ihre einzigartige Präsenz im Web aufzubauen und weiterzuentwickeln. Ich nehme auch gerne an einzelnen Projekten teil, fordere mich gerne selbst heraus und lerne immer etwas Neues.',
